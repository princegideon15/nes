<template>
    ...
    <div class="p-4 sm:ml-64 mt-14 bg-gray-100">
        ...
        <div class="grid grid-cols-2 gap-4 mb-4">
            <div class="w-full rounded-lg border border-dark-800 shadow border-gray-200 bg-white">
                <div class="border-b border-gray-200 dark:border-gray-700">
                    <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="myTab"
                        ...
                        <li class="mr-2" role="presentation">
                            <button
                                class="inline-block p-4 rounded-t-lg border-b-2 hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 font-semibold"
                                id="registration-tab" data-tabs-target="#registration" type="button" role="tab"
                                aria-controls="registration" aria-selected="false">Registration Profile</button>
                        </li>
                    </ul>
                </div>

                <div id="myTabContent">
                    <div class="hidden p-3 rounded-lg bg-white dark:bg-gray-800" id="account" role="tabpanel"
                                ...
                                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                    <tbody>
                                        <tr class="bg-white dark:bg-gray-800 py-5">
                                            ...
                                            <td class="py-3">
                                                <input type="email" id="email"
                                                    ...
                                                    placeholder="name@flowbite.com" v-bind:value="row.email" readonly>
                                            </td>
                                        </tr>
                                        <tr class="bg-white dark:bg-gray-800">
                                            ...
                                            <td class="py-3">
                                                <ValidationProvider name="confirm" rules="required|min:8"
                                                    v-slot="{ errors }">
                                                    <div class="relative">
                                        ...
                                        <tr class="bg-white dark:bg-gray-800">
                                            ...
                                            <td class="py-3">
                                                <ValidationProvider rules="required|password:@confirm|min:8"
                                                    v-slot="{ errors }">
                                                    <div class="relative">
                                                        <input type="password" name="confirm-password"
                                                            id="confirm-password" v-model="accountForm.password_confirm"
                                                            class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                            placeholder="••••••••" required>
                    ...
                    <div class="hidden p-3 rounded-lg bg-white dark:bg-gray-800" id="personal" role="tabpanel"
                                ...
                                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                    <tbody>
                                        ...
                                        <tr class="bg-white dark:bg-gray-800">
                                            ...
                                            <td class="py-3">
                                                <ValidationProvider rules="required" v-slot="{ errors }">
                                                    <select v-model="personalForm.pp_title"
                                        ...
                                        <tr class="bg-white dark:bg-gray-800">
                                            ...
                                            <td class="py-3">
                                                <ValidationProvider rules="required" v-slot="{ errors }">
                                                    <input type="text" v-model="personalForm.pp_last_name"
                                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                        placeholder="" />
                                                    <span class="block text-red-600">{{ errors[0] }}</span>
                                                </ValidationProvider>
                                        ...
                                        <tr class="bg-white dark:bg-gray-800">
                                            <th scope="row"
                                                class="font-medium text-gray-900 whitespace-nowrap dark:text-white py-3">
                                                Middle name<span
                                                    class="text-xs font-normal text-gray-900"><br>(optional)</span>
                                            </th>
                                            <td class="py-3">
                                                <input type="text" v-model="personalForm.pp_middle_name"
                                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                    placeholder="" />
                                            </td>
                                        </tr>
                                        <tr class="bg-white dark:bg-gray-800">
                                            ...
                                            <td class="py-3">
                                                <ValidationProvider rules="required" v-slot="{ errors }">
                                                    <input type="text" v-model="personalForm.pp_first_name"
                                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                        placeholder="" />
                                                    <span class="block text-red-600">{{ errors[0] }}</span>
                                                </ValidationProvider>
                                        ...
                                        <tr class="bg-white dark:bg-gray-800">
                                            ...
                                            <td class="py-3">
                                                <input type="text" v-model="personalForm.pp_extension" name="extension"
                                                    id="extension" autocomplete="extension"
                                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-1/3 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        ...
                                        <tr class="bg-white dark:bg-gray-800">
                                            ...
                                            <td class="py-3">
                                                <ValidationProvider rules="required|between:18,100" v-slot="{ errors }">
                                                    <input type="number" v-model="personalForm.pp_age"
                                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-1/2 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                        placeholder="" />
                                                    <span class="block text-red-600">{{ errors[0] }}</span>
                                                </ValidationProvider>
                                        ...
                                        <tr>
                                            <td colspan="2" class="pt-5">Address details</td>
                                        </tr>
                                        <tr class="bg-white dark:bg-gray-800">
                                            <th scope="row"
                                                class="font-medium text-gray-900 whitespace-nowrap dark:text-white py-3">
                                            ...
                                            <td class="py-3">
                                                <ValidationProvider rules="required" v-slot="{ errors }">
                                                    <select id="region" v-model="personalForm.pp_region"
                                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                        @change="getProvinces()">
                                        ...
                                        <tr class="bg-white dark:bg-gray-800">
                                            ...
                                            <td class="py-3">
                                                <ValidationProvider rules="required" v-slot="{ errors }">
                                                    <select id="province" v-model="personalForm.pp_prov"
                                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                        @change="getCities()">
                                                        <option value="">Select here</option>
                                        ...
                                        <tr class="bg-white dark:bg-gray-800">
                                            ...
                                            <td class="py-3">
                                                <ValidationProvider rules="required" v-slot="{ errors }">
                                                    <select id="city" v-model="personalForm.pp_city"
                                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                        <option value="">Select here</option>
                                        ...
                                        <tr class="bg-white dark:bg-gray-800">
                                            ...
                                            <td class="py-3">
                                                <ValidationProvider rules="required" v-slot="{ errors }">
                                                    <input type="text" v-model="personalForm.pp_brgy"
                                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                        placeholder="" />
                                                    <span class="block text-red-600">{{ errors[0] }}</span>
                                                </ValidationProvider>
                                        ...
                                        <tr>
                                            <td colspan="2" class="pt-5">Employment details</td>
                                        </tr>
                                        <tr class="bg-white dark:bg-gray-800">
                                            <th scope="row"
                                                class="font-medium text-gray-900 whitespace-nowrap dark:text-white py-3">
                                            ...
                                            <td class="py-3">
                                                <ValidationProvider rules="required" v-slot="{ errors }">
                                                    <input type="text" v-model="personalForm.pp_ins"
                                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                        placeholder="" />
                                                    <span class="block text-red-600">{{ errors[0] }}</span>
                                                </ValidationProvider>
                                        ...
                                        <tr class="bg-white dark:bg-gray-800">
                                            ...
                                            <td class="py-3">
                                                <ValidationProvider rules="required" v-slot="{ errors }">
                                                    <input type="text" v-model="personalForm.pp_pos"
                                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                        placeholder="" />
                                                    <span class="block text-red-600">{{ errors[0] }}</span>
                                                </ValidationProvider>
                    ...
                    <div class="hidden p-3 rounded-lg bg-white dark:bg-gray-800" id="registration" role="tabpanel"
                            ...
                            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                <tbody>
                                    <tr class="bg-white dark:bg-gray-800">
                                        ...
                                        <td class="py-3">
                                            <select v-model="registrationForm.reg_category"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                @change='getSubCategories()' disabled>
                                                <option value="" selected disabled>Select</option>
                                    ...
                                    <tr v-if="registrationForm.reg_category == 2" class="bg-white dark:bg-gray-800">
                                        ...
                                        <td class="py-3">
                                            <select v-model="registrationForm.sub_category"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                @change='getStakeholderSubCategories($event)' disabled>
                                                <option value="" selected disabled>Select Stakeholder</option>
                                                <option v-for="row in results" v-bind:value="row.stk_id">
                                                    {{ row.stk_name }}</option>
                                            </select>
                                        </td>
                                    </tr>
                                    <tr v-if="registrationForm.reg_category == 3" class="bg-white dark:bg-gray-800">
                                        ...
                                        <td class="py-3">
                                            <select v-model="registrationForm.sub_category"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                @change='getManagementSubCategories($event)' disabled>
                                                <option value="" selected disabled>Select Management</option>
                                                <option v-for="row in results" v-bind:value="row.mgt_id">
                                                    {{ row.mgt_name }}</option>
                                            </select>
                                        </td>
                                    </tr>
                                    <tr v-if="show_res_sub_stake == true" class="bg-white dark:bg-gray-800">
                                        ...
                                        <td class="py-3">
                                            <select v-model="registrationForm.sub2_category"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                disabled>
                                                <option value="" selected disabled>Select here</option>
                                                <option v-for="row in results_sub_stake"
                                                    v-bind:value="row.sub_stake_id">{{ row.sub_stake_name }}</option>
                                            </select>
                                        </td>
                                    </tr>
                                    <tr v-if="show_res_sub_manage == true" class="bg-white dark:bg-gray-800">
                                        ...
                                        <td class="py-3">
                                            <select v-model="registrationForm.sub2_category"
                                                class="mt-1 block rounded-md border-gray-300 bg-white py-2 px-3 text-gray-900 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm  md:text-md lg:text-lg border-0 border-b-2 w-full"
                                                disabled>
                                                <option value="">Select here</option>
            ...
            <div
                    ...
                    <article v-for="row in feedbacks">
                        <div class="flex items-center mb-4 space-x-4">
                            ...
                            <div class="space-y-1 font-medium dark:text-white">
                                <p> {{ row.pp_first_name + ' ' + row.pp_last_name }}
                ...
                <div v-else>
                    <div class="w-full p-6 bg-white dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <p class="mb-3 text-sm font-normal text-gray-500 dark:text-gray-400">Send your first feedback by
                            clicking the button on the side menu.</p>
                    </div>
        ...
        methods: {
            getProvinces: function () {
                axios.get(APP_URL + '/get_provinces', {
                        params: {
                            id: this.personalForm.pp_region
                        }
                    })
            ...
            getStakeholderSubCategories: function (e) {
                ...
                axios.get(APP_URL + '/get_sub_stake', {
                        params: {
                            id: this.registrationForm.sub_category
                        }
                    })
                    .then(function (response) {
