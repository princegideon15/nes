    ...
    <div
        ...
        <div class="w-full flex justify-center items-center">
            <a href="https://nrcp.dost.gov.ph/" target="_blank">
                <img class="h-14 w-14 mr-1" src="{{ asset(config('app.nrcp')) }}" alt="NRCP Logo">
            </a>
            <img class="h-14 w-14" src="{{ asset(config('app.logo')) }}" alt="NES Logo">
            <!-- <span class="mb-1 text-5xl font-bold tracking-tight text-blue-900 text-center">NES</span> -->
        </div>

        <h2 class="mt-3 mb-1 text-2xl font-bold tracking-tight text-gray-900 text-center">NRCP Extension Services</h2>
        <p class="text-center text-gray-500 mb-6">Log in to your account</p>
        ...
        <form class="space-y-6" method="POST" action="{{ url('/dologin') }}">
            ...
            <div id="alert-border-3"
                class="flex p-4 mb-4 text-green-800 border border-green-300 rounded-lg border-t-4 border-green-300 bg-green-50 dark:text-green-400 dark:bg-gray-800 dark:border-green-800"
                role="alert">
                <svg class="flex-shrink-0 w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="email" name="email" id="email"
                        class="pl-10 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-4 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white @error('email') is-invalid @enderror"
            ...
            <button type="submit"
                class="w-full text-white bg-blue-900 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm p-4 text-center mr-2 mb-2">LOGIN</button>
            ...
            <div class="flex items-start">
                ...
                <div class="text-sm font-medium text-gray-500 dark:text-gray-300">
                    Not registered? <a href="{{ url('/register') }}"
                        class="text-blue-800 hover:underline dark:text-blue-500">Sign up</a>
                </div>

                <a href="{{ url('/forgot') }}"
                    class="ml-auto text-sm text-blue-800 hover:underline dark:text-blue-500">Forgot Password?</a>
            </div>
        ...
        <div class="mt-1">
            <form method="POST" action="{{ url('/tracker') }}" target="_blank">
                @csrf
                <label for="default-search" class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">Track
