...
<div class="h-screen flex bg-gray-200">
    ...
    <div class="w-full flex flex-col h-screen justify-between"
        style="background-image:url({{URL::asset('/images/bg.jpg')}});background-repeat: no-repeat;background-size: cover;">

        <main>
            <a href="#" class="w-full block p-6 text-white">
                <h5 class="mb-2 text-2xl font-bold tracking-tight">NRCP EXTENSION SERVICES (NES)</h5>
                <p class="font-normal">The National Research Council of the Philippines’ EXTENSION SERVICES (NES)
                    principally aim to explain the benefits of basic
                    research to a larger public and how their results may be used and or contribute in addressing local,
                    national, and international
                    problems on health, energy, environment and natural hazards, food and water sustainability and
                    security, peace, governance,
                    and other issues influencing the lives of people across the regions.
                </p>
            </a>
        ...
        <footer class="text-white">
            ...
            <div class="px-4 py-6 md:flex md:items-center md:justify-between w-full">
                <span class="text-sm text-white 300 sm:text-center">© 2023 <a href="https://flowbite.com/">NES</a>. All
                    Rights Reserved.
                </span>
    ...
    <div
        class="w-2/4 h-full p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700 ">
        <form class="space-y-6" method="POST" action="{{ url('/dologin') }}">
            @csrf

            <div class="w-full text-center">
                <div class="text-center inline-flex items-center">
                    <img class="mr-1 h-12 w-10 h-10 mx-auto" src="https://flowbite.com/docs/images/logo.svg"
                        alt="Your Company">
                    <p class="text-5xl font-bold tracking-tight text-gray-900">NES</p>
                </div>
            ...
            <button type="submit"
                class="w-full text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm p-4 text-center mr-2 mb-2">LOGIN</button>
            ...
            <div class="flex items-start">
                ...
                <a href="{{ url('/forgot') }}"
                    class="ml-auto text-sm text-blue-700 hover:underline dark:text-blue-500">Forgot Password?</a>
            </div>
