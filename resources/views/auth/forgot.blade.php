    ...
    <div class="w-full max-w-lg p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
        ...
        @csrf
          <div>
            ...
            <h2 class="mt-3 mb-1 text-3xl font-bold tracking-tight text-gray-900 text-center">Forgot Your Password?</h2>
          </div>
            <div>
                <p class="text-gray-500 mb-6">To reset your password, enter the registered email address and we will send you paassword reset instructions on your email.</p>
                <div class="relative">
