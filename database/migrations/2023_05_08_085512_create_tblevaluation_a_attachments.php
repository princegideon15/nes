...
class CreateTblevaluationAAttachments extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tblevaluation_a_attachments', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tblevaluation_a_attachments');
    }
}
