...
class CreateTblfinalizationAAttachments extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tblfinalization_a_attachments', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tblfinalization_a_attachments');
    }
}
